...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { title: "Dr. Aditi Soni | AI Product Manager" },
      ...
      { property: "og:description", content: "Portfolio of Dr. Aditi Soni, a clinician-turned-AI Product Manager building healthcare AI products at the intersection of clinical expertise and technology." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:title", content: "Dr. Aditi Soni | AI Product Manager" },
      { name: "twitter:description", content: "Portfolio of Dr. Aditi Soni, a clinician-turned-AI Product Manager building healthcare AI products at the intersection of clinical expertise and technology." },
