  ...
  return (
    <section id="projects" className="bg-paper-warm py-20 lg:py-28">
      <div ref={ref} className="fade-in-section mx-auto max-w-7xl px-6">
        ...
        <h2 className="text-3xl font-bold text-ink sm:text-4xl">What I build when I'm curious.</h2>
        ...
        <div className="mt-12 grid gap-6 sm:grid-cols-2">
          {projects.map((p) => (
            <div key={p.title} className="project-card rounded-lg border border-border-warm bg-card p-6">
              ...
              <p className="mt-3 text-sm font-light leading-relaxed text-ink-muted">{p.desc}</p>
              <a href="https://github.com/Aditisoni99" target="_blank" rel="noopener noreferrer" className="mt-4 inline-block text-sm font-medium text-accent-red hover:underline">
                View on GitHub ↗
              </a>
            </div>
          ))}
