      ...
      <div ref={ref} className="fade-in-section mx-auto max-w-7xl">
        ...
        <div className="grid gap-8 lg:grid-cols-2">
          ...
          <div style={{ border: "0.5px solid #EEE8DC", display: "flex", overflow: "hidden" }} className="flex-col sm:flex-row">
            ...
            >
              <p style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 24, color: "#C8A882", marginBottom: 12 }}>Visualize</p>
            ...
            <div style={{ padding: 20, background: "#FFFFFF" }}>
              <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 9, letterSpacing: "0.1em", color: "#A8C4C8", marginBottom: 8 }}>LIVE PRODUCT</p>
              <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 22, fontWeight: 400, color: "#1A1410", marginBottom: 6 }}>Visualize</h3>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, fontWeight: 300, lineHeight: 1.6, color: "#7A7060", marginBottom: 12 }}>
              ...
              <a
                ...
                style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 10, color: "#C8A882", textDecoration: "none" }}
              >
          ...
          {projects.map((p) => (
            <div key={p.title} style={{ border: "0.5px solid #EEE8DC", padding: 24 }}>
              <p style={{ fontFamily: "'DM Mono', monospace", fontSize: 9, letterSpacing: "0.1em", color: "#A8C4C8", marginBottom: 8 }}>{p.tag.toUpperCase()}</p>
              <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 22, fontWeight: 400, color: "#1A1410", marginBottom: 6 }}>{p.title}</h3>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, fontWeight: 300, lineHeight: 1.6, color: "#7A7060", marginBottom: 12 }}>{p.desc}</p>
              <a
