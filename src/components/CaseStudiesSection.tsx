      ...
      <div ref={ref} className="fade-in-section mx-auto max-w-7xl">
        ...
        <div className="mt-12 grid gap-8 lg:grid-cols-2">
          ...
          <div style={{ border: "0.5px solid #EEE8DC", padding: 32 }}>
            ...
            <span style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, letterSpacing: "0.1em", color: "#3A3530", display: "inline-block", marginTop: 12 }}>AI PRODUCT · BIOPHARMA</span>
            <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 26, fontWeight: 400, color: "#1A1410", marginTop: 12, lineHeight: 1.1 }}>
              Reducing Clinical Trial Protocol from 6 Months to 4 Months
            </h3>
            <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, fontWeight: 300, lineHeight: 1.9, color: "#3A3530", marginTop: 12 }}>
            ...
            <div style={{ marginTop: 20 }}>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, textTransform: "uppercase", letterSpacing: "0.08em", color: "#3A3530", marginBottom: 8 }}>My Role</p>
              <ul className="space-y-1.5">
                {[
                  ...
                  <li key={i} style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 14, fontWeight: 300, lineHeight: 1.9, color: "#3A3530" }}>{b}</li>
                ))}
              </ul>
            </div>

            <div style={{ marginTop: 20, borderLeft: "0.5px solid #A07850", paddingLeft: 16 }}>
              <p style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 11, textTransform: "uppercase", letterSpacing: "0.08em", color: "#3A3530", marginBottom: 8 }}>Key Learnings</p>
            ...
            <div className="mt-5 flex flex-wrap gap-2">
              {["6 mo → 4 mo", "40% faster FPI", "30+ partners", "$120K saved/protocol", "95% clinical accuracy"].map((c) => (
                <span key={c} style={{ fontFamily: "'DM Sans', sans-serif", fontSize: 10, color: "#3A3530", border: "0.5px solid #C0B0A0", padding: "4px 10px" }}>{c}</span>
              ))}
            </div>
          </div>
          ...
          <div style={{ border: "0.5px solid #EEE8DC", padding: 32 }}>
            ...
            <span style={{ fontFamily: "'DM Mono', monospace", fontSize: 10, letterSpacing: "0.1em", color: "#3A3530", display: "inline-block", marginTop: 12 }}>SYSTEMS · OPERATIONS</span>
            <h3 style={{ fontFamily: "'Cormorant Garamond', serif", fontSize: 26, fontWeight: 400, color: "#1A1410", marginTop: 12, lineHeight: 1.1 }}>
